...
| `slug`    | string | `false` | The slug of the bingo event the user is participating in.                         |
...
| Column           | Type    | Null    | Description                                                                                                                       |
| ---------------- | ------- | ------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `slug`           | string  | `false` | The slug of the bingo event the tile is part of.                                                                                  |
...
| Column           | Type   | Null    | Description                                                                                           |
| ---------------- | ------ | ------- | ----------------------------------------------------------------------------------------------------- |
| `slug`           | string | `false` | The slug of the bingo event the team is part of.                                                      |
| `name`           | string | `false` | The name of the team. Must be unique for a specific `slug`.                                           |
| `nameNormalized` | string | `false` | The normalized version of the team name, for search queries. Must be unique for a specific `slug`.    |
...
| `slug`        | string   | `false` | The slug of the bingo event the invitation is part of.                     |
...
| `slug`       | string   | `false` | The slug of the bingo event the application is part of.           |
...
| `slug`       | string | `false` | The ID of the bingo event the completion is for.          |
